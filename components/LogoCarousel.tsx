...
export const LogoCarousel: React.FC = () => {
  return (
    <section className="py-16 sm:py-20 overflow-hidden relative bg-transparent">
      <div className="absolute inset-y-0 left-0 w-20 sm:w-40 bg-gradient-to-r from-white via-white/80 to-transparent z-10"></div>
      <div className="absolute inset-y-0 right-0 w-20 sm:w-40 bg-gradient-to-l from-white via-white/80 to-transparent z-10"></div>
      ...
      <div className="relative">
        <div className="logo-track flex gap-12 sm:gap-24 py-4">
          {[...LOGOS, ...LOGOS].map((tech, i) => (
            <div
              key={i}
              className="flex-shrink-0 flex items-center justify-center grayscale opacity-30 hover:grayscale-0 hover:opacity-100 transition-all duration-700"
