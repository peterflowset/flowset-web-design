    ...
    <section className="flex items-center py-16 sm:py-20 relative overflow-hidden bg-transparent">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-4 sm:gap-6 items-stretch max-w-6xl mx-auto">
          ...
          >
            <div className="flex-[1.2] p-8 sm:p-10 bg-white border-r border-gray-50">
              <div className="flex items-center gap-3 sm:gap-3 mb-8 sm:mb-8">
                <div className="w-10 h-10 sm:w-10 sm:h-10 bg-blue-50 text-[#316bff] rounded-xl flex items-center justify-center shadow-sm">
                  <Sparkles size={18} className="sm:w-5 sm:h-5" />
                </div>
                <h3 className="text-2xl sm:text-2xl font-bold tracking-tight">Standard Paket</h3>
              </div>
            ...
            <div className="flex-1 p-8 sm:p-10 bg-[#316bff] text-white flex flex-col relative overflow-hidden">
              ...
              <div className="space-y-6 sm:space-y-6 relative z-10 mb-8 md:mb-0">
                <div className="flex justify-between items-center opacity-60">
                  <span className="font-bold uppercase tracking-[0.2em] sm:tracking-[0.25em] text-[9px]">Basispreis</span>
                  <span className="text-lg sm:text-lg font-bold font-mono">2.000€</span>
                </div>
                <div className="flex justify-between items-center text-blue-200">
                  ...
                  <span className="text-lg sm:text-lg font-bold font-mono">− 1.200€</span>
                </div>
                <div className="h-px bg-white/10 my-6 sm:my-6"></div>
                <div className="flex flex-col gap-2 sm:gap-2">
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-6xl sm:text-6xl font-bold text-white leading-none tracking-tighter drop-shadow-lg">800€</span>
