    ...
    <section className="py-32 bg-white" ref={containerRef}>
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">In Rekordzeit <br /><span className="text-gray-300 italic">zum Ergebnis.</span></h2>
          <div className="inline-flex items-center gap-3 bg-gray-50 border border-gray-100 text-gray-500 px-6 py-2.5 rounded-full text-[10px] font-bold uppercase tracking-widest shadow-sm mt-4">
            <Clock size={16} className="text-[#316bff]" />
        ...
        <div className="max-w-5xl mx-auto relative px-4 md:px-0">
          ...
          {/* The Vertical Line Track (Absolute Centered) */}
      ...
      {/* Background Decor */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-blue-50/20 blur-[130px] rounded-full -z-20 pointer-events-none"></div>
